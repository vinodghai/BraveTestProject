...
import com.example.bravetestproject.*
import com.example.bravetestproject.btcassetlist.adapter.BtcAssetAdapter
import com.example.bravetestproject.btcassetlist.viewmodel.MainActivityViewModel
import com.example.bravetestproject.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), TimerCallback {
    ...
    private fun setMenu() {
        binding.toolbar.ivMenu.setOnClickListener {
            val popupMenu = PopupMenu(this@MainActivity, binding.toolbar.ivMenu)
